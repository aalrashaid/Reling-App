  ...
  var controls = {
    ...
    updateProgress: function updateProgress(event) {
      ...
      var setProgress = function setProgress(target, input) {
        ...
        var progress = is.element(target) ? target : _this9.elements.display.buffer; // Update value and label
    ...
    update: function update() {
      ...
      if (this.isHTML5 && this.isVideo) {
        tracks.filter(function (track) {
          ...
          _this17.debug.log('Track added', track); // Attempt to store if the original dom element was "default"
  ...
  var Fullscreen = /*#__PURE__*/function () {
    function Fullscreen(player) {
      ...
      _defineProperty$1(this, "onChange", function () {
        ...
        var target = _this21.target === _this21.player.media ? _this21.target : _this21.player.elements.container; // Trigger an event
      ...
      _defineProperty$1(this, "toggleFallback", function () {
        ...
        toggleClass(_this21.target, _this21.player.config.classNames.fullscreen.fallback, toggle); // Force full viewport on iPhone X+
      ...
      _defineProperty$1(this, "trapFocus", function (event) {
        ...
        if (browser.isIos || !_this21.active || event.key !== 'Tab' || event.keyCode !== 9) {
          return;
      ...
      _defineProperty$1(this, "enter", function () {
        ...
        } else if (!Fullscreen["native"] || _this21.forceFallback) {
      ...
      _defineProperty$1(this, "exit", function () {
        ...
        if (browser.isIos && _this21.player.config.fullscreen.iosNative) {
          _this21.target.webkitExitFullscreen();
  ...
  var ui = {
    ...
    checkLoading: function checkLoading(event) {
      ...
      this.timers.loading = setTimeout(function () {
        ...
        toggleClass(_this25.elements.container, _this25.config.classNames.loading, _this25.loading); // Update controls visibility
    ...
    migrateStyles: function migrateStyles() {
      ...
      .filter(function (key) {
        ...
        _this26.elements.container.style.setProperty(key, _this26.media.style.getPropertyValue(key)); // Clean up from media element
  ...
  var Listeners = /*#__PURE__*/function () {
    function Listeners(_player) {
      ...
      _defineProperty$1(this, "setTabFocus", function (event) {
        var player = _this27.player;
        var elements = player.elements;
        clearTimeout(_this27.focusTimer); // Ignore any key other than tab
        ...
        if (event.type === 'keydown') {
          _this27.lastKeyDown = event.timeStamp;
        ...
        var wasKeyDown = event.timeStamp - _this27.lastKeyDown <= 20; // Ignore focus events if a key was pressed prior
        ...
        if (event.type !== 'focusout') {
          _this27.focusTimer = setTimeout(function () {
      ...
      _defineProperty$1(this, "global", function () {
        ...
        var player = _this27.player; // Keyboard shortcuts
        ...
        toggleListener.call(player, document.body, 'click', _this27.toggleMenu, toggle); // Detect touch by events

        once.call(player, document.body, 'touchstart', _this27.firstTouch); // Tab focus detection

        toggleListener.call(player, document.body, 'keydown focus blur focusout', _this27.setTabFocus, toggle, false, true);
      });
      ...
      _defineProperty$1(this, "controls", function () {
        ...
        _this27.bind(elements.buttons.restart, 'click', player.restart, 'restart'); // Rewind
        ...
        _this27.bind(elements.buttons.airplay, 'click', player.airplay, 'airplay'); // Settings menu - click toggle
        ...
        _this27.bind(elements.controls, 'focusin', function () {
          ...
          var delay = _this27.touch ? 3000 : 4000; // Clear timer
    ...
    getTitle: function getTitle(videoId) {
      ...
      fetch(url).then(function (data) {
        if (is.object(data)) {
          ...
          ui.setTitle.call(_this30); // Set aspect ratio
  ...
  var Ads = /*#__PURE__*/function () {
    ...
    function Ads(player) {
      ...
      _defineProperty$1(this, "ready", function () {
        ...
        _this31.startSafetyTimer(12000, 'ready()'); // Clear the safety timer
        ...
        _this31.listeners(); // Setup the IMA SDK
      ...
      _defineProperty$1(this, "setupIMA", function () {
        ...
        _this31.player.elements.container.appendChild(_this31.elements.container); // So we can run VPAID2


        google.ima.settings.setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.ENABLED); // Set language

        google.ima.settings.setLocale(_this31.player.config.ads.language); // Set playback for iOS10+

        google.ima.settings.setDisableCustomPlaybackForIOS10Plus(_this31.player.config.playsinline); // We assume the adContainer is the video container of the plyr element that will house the ads

        _this31.elements.displayContainer = new google.ima.AdDisplayContainer(_this31.elements.container, _this31.player.media); // Create ads loader

        _this31.loader = new google.ima.AdsLoader(_this31.elements.displayContainer); // Listen and respond to ads loaded and error events
      ...
      _defineProperty$1(this, "requestAds", function () {
        ...
        try {
          ...
          request.adTagUrl = _this31.tagUrl; // Specify the linear and nonlinear slot sizes. This helps the SDK
      ...
      _defineProperty$1(this, "onAdsManagerLoaded", function (event) {
        ...
        _this31.manager = event.getAdsManager(_this31.player, settings); // Get the cue points for any mid-rolls by filtering out the pre- and post-roll

        _this31.cuePoints = _this31.manager.getCuePoints(); // Add listeners to the required events
      ...
      _defineProperty$1(this, "onAdEvent", function (event) {
        var container = _this31.player.elements.container; // Retrieve the ad from the event. Some events (e.g. ALL_ADS_COMPLETED)
        ...
        switch (event.type) {
          case google.ima.AdEvent.Type.LOADED:
            ...
            _this31.trigger('loaded'); // Start countdown
      ...
      _defineProperty$1(this, "play", function () {
        ...
        _this31.managerPromise.then(function () {
          // Set volume to match player
          _this31.manager.setVolume(_this31.player.volume); // Initialize the container. Must be done via a user action on mobile devices
          ...
          try {
            if (!_this31.initialized) {
              ...
              _this31.manager.init(container.offsetWidth, container.offsetHeight, google.ima.ViewMode.NORMAL); // Call play to start showing the ad. Single video and overlay ads will
      ...
      _defineProperty$1(this, "resumeContent", function () {
        ...
        _this31.elements.container.style.zIndex = ''; // Ad is stopped

        _this31.playing = false; // Play video
      ...
      _defineProperty$1(this, "pauseContent", function () {
        ...
        _this31.elements.container.style.zIndex = 3; // Ad is playing

        _this31.playing = true; // Pause our video.
      ...
      _defineProperty$1(this, "cancel", function () {
        ...
        _this31.trigger('error'); // Re-create our adsManager
      ...
      _defineProperty$1(this, "loadAds", function () {
        ...
        _this31.managerPromise.then(function () {
          ...
          _this31.initialized = false; // Now request some new advertisements
      ...
      this.managerPromise = new Promise(function (resolve, reject) {
        ...
        _this31.on('loaded', resolve); // Ads failed
    ...
    function PreviewThumbnails(player) {
      ...
      _defineProperty$1(this, "load", function () {
        ...
        _this32.getThumbnails().then(function () {
          ...
          _this32.render(); // Check to see if thumb container size was specified manually in CSS
      ...
      _defineProperty$1(this, "startMove", function (event) {
        ...
        if (event.type === 'touchmove') {
          ...
          _this32.mousePosX = event.pageX; // Set time text inside image container
      ...
      _defineProperty$1(this, "startScrubbing", function (event) {
        ...
        if (is.nullOrUndefined(event.button) || event.button === false || event.button === 0) {
          _this32.mouseDown = true; // Wait until media has a duration

          if (_this32.player.media.duration) {
            _this32.toggleScrubbingContainer(true);

            _this32.toggleThumbContainer(false, true); // Download and show image
      ...
      _defineProperty$1(this, "endScrubbing", function () {
        _this32.mouseDown = false; // Hide scrubbing preview. But wait until the video has successfully seeked before hiding the scrubbing preview
      ...
      _defineProperty$1(this, "render", function () {
        ...
        _this32.elements.thumb.container.appendChild(_this32.elements.thumb.imageContainer); // Create HTML element, parent+span: time text (e.g., 01:32:00)
        ...
        _this32.elements.thumb.container.appendChild(timeContainer); // Inject the whole thumb
      ...
      _defineProperty$1(this, "loadImage", function () {
        ...
        if (!_this32.currentImageElement || _this32.currentImageElement.dataset.filename !== thumbFilename) {
          ...
          _this32.player.debug.log("Loading image: ".concat(thumbUrl)); // For some reason, passing the named function directly causes it to execute immediately. So I've wrapped it in an anonymous function...
                ...
                if (newThumbFilename !== oldThumbFilename) {
                  ...
                  if (!_this32.loadedImages.includes(newThumbFilename)) {
                    ...
                    previewImage.onload = function () {
                      ...
                      if (!_this32.loadedImages.includes(newThumbFilename)) _this32.loadedImages.push(newThumbFilename); // We don't resolve until the thumb is loaded
      ...
      _defineProperty$1(this, "setThumbContainerSizeAndPos", function () {
        if (!_this32.sizeSpecifiedInCSS) {
          ...
          _this32.elements.thumb.imageContainer.style.height = "".concat(_this32.thumbContainerHeight, "px");
          _this32.elements.thumb.imageContainer.style.width = "".concat(thumbWidth, "px");
        } else if (_this32.elements.thumb.imageContainer.clientHeight > 20 && _this32.elements.thumb.imageContainer.clientWidth < 20) {
          var _thumbWidth = Math.floor(_this32.elements.thumb.imageContainer.clientHeight * _this32.thumbAspectRatio);

          _this32.elements.thumb.imageContainer.style.width = "".concat(_thumbWidth, "px");
        } else if (_this32.elements.thumb.imageContainer.clientHeight < 20 && _this32.elements.thumb.imageContainer.clientWidth > 20) {
          var thumbHeight = Math.floor(_this32.elements.thumb.imageContainer.clientWidth / _this32.thumbAspectRatio);
          _this32.elements.thumb.imageContainer.style.height = "".concat(thumbHeight, "px");
        }
      ...
      _defineProperty$1(this, "setThumbContainerPos", function () {
        var seekbarRect = _this32.player.elements.progress.getBoundingClientRect();

        var plyrRect = _this32.player.elements.container.getBoundingClientRect();

        var container = _this32.elements.thumb.container; // Find the lowest and highest desired left-position, so we don't slide out the side of the video container

        var minVal = plyrRect.left - seekbarRect.left + 10;
        var maxVal = plyrRect.right - seekbarRect.left - container.clientWidth - 10; // Set preview container position to: mousepos, minus seekbar.left, minus half of previewContainer.clientWidth

        var previewPos = _this32.mousePosX - seekbarRect.left - container.clientWidth / 2;
      ...
      _defineProperty$1(this, "setImageSizeAndOffset", function (previewImage, frame) {
        ...
        var multiplier = _this32.thumbContainerHeight / frame.h; // eslint-disable-next-line no-param-reassign
  ...
  var source = {
    ...
    change: function change(input) {
      ...
      this.destroy.call(this, function () {
        ...
        _this34.options.quality = []; // Remove elements

        removeElement(_this34.media);
        _this34.media = null; // Reset class name
        ...
        _this34.elements.container.appendChild(_this34.media); // Autoplay the new source?
        ...
        ui.addStyleHook.call(_this34); // Set new sources for html5
        ...
        _this34.config.title = input.title; // Set up from scratch

        media.setup.call(_this34); // HTML5 stuff
        ...
        if (!is.empty(input.previewThumbnails)) {
          Object.assign(_this34.config.previewThumbnails, input.previewThumbnails); // Cleanup previewThumbnails plugin if it was loaded
    ...
    function Plyr(target, options) {
      ...
      _defineProperty$1(this, "toggleControls", function (toggle) {
        ...
        if (_this35.supported.ui && !_this35.isAudio) {
          ...
          var isHidden = hasClass(_this35.elements.container, _this35.config.classNames.hideControls); // Negate the argument if not undefined since adding the class to hides the controls

          var force = typeof toggle === 'undefined' ? undefined : !toggle; // Apply and get updated state

          var hiding = toggleClass(_this35.elements.container, _this35.config.classNames.hideControls, force); // Close menu
      ...
      _defineProperty$1(this, "destroy", function (callback) {
        ...
        var done = function done() {
          ...
          _this35.embed = null; // If it's a soft destroy, make minimal changes
          ...
          if (soft) {
            if (Object.keys(_this35.elements).length) {
              ...
              removeElement(_this35.elements.wrapper); // Clear for GC
            ...
            // Unbind listeners
            unbindListeners.call(_this35); // Cancel current network requests

            html5.cancelRequests.call(_this35); // Replace the container with the original element provided

            replaceElement(_this35.elements.original, _this35.elements.container); // Event

            triggerEvent.call(_this35, _this35.elements.original, 'destroyed', true); // Callback
            ...
            _this35.ready = false; // Clear for garbage collection
        ...
        _this35.stop(); // Clear timeouts


        clearTimeout(_this35.timers.loading);
        clearTimeout(_this35.timers.controls);
        clearTimeout(_this35.timers.resized); // Provider specific stuff

        if (_this35.isHTML5) {
          // Restore native video controls
          ui.toggleNativeControls.call(_this35, true); // Clean up

          done();
        } else if (_this35.isYouTube) {
          // Clear timers
          clearInterval(_this35.timers.buffering);
          clearInterval(_this35.timers.playing); // Destroy YouTube API
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/plyrjs/plyr.js");
/******/ 	
/******/ })()
;